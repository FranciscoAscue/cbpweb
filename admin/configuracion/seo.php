...
$sentencia = $conn_web->prepare("SELECT * FROM `SEO`;");
$sentencia->execute();
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">SEO Pagina Principal &emsp;
            </h5>
                ...
                <tbody>
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <td scope="row"><?php echo $registro["TITLE"]; ?></td>
                      <td scope="row">
                        <a name="" id="" class="btn btn-warning" 
                        href="seo_editar.php?ID=<?php echo $registro['ID']; ?>" 
