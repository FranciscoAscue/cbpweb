...
if(isset($_POST["titulo"])){
  ...
  $sentencia = $conn_web -> prepare("INSERT INTO `COMUNICACIONES`(`ID`,`TITULO`,`FOTO`,`PDF`,`TAG`,`AUTHOR`, `DESCRIPCION`, `FECHA`) 
  VALUES (null,:titulo,:foto, null, :tag, null, :contenido, :fecha );");
          ...
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                <div class="col-sm-3">
                  <button type="submit" class="btn btn-primary">Ingresar Notificacion</button>
                </div>
                <div class="col-sm-2">
