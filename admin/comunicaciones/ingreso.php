...
$sentencia = $conn_web->prepare("SELECT * FROM `COMUNICACIONES`;");
$sentencia->execute();
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `COMUNICACIONES` WHERE ID = :id;");
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Comunicaciones  &emsp;
            <a href="ingreso_agregar.php" class="btn btn-primary">+ Agregar </a>
            </h5>
                ...
                <tbody>
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <td scope="row">
                      <img width="50" src="../../assets/img/gallery/<?php echo $registro["FOTO"] ?>">
                      </td>
                      <td scope="row"><?php echo $registro["FECHA"]; ?></td>
                      <td scope="row">
                      <a name="" id="" class="btn btn-warning" 
                        href="ingreso_editar.php?ID=<?php echo $registro['ID']; ?>" 
...
<script>
    function borrar(id) {
        ...
        Swal.fire({
            title: 'Desea borrar la Notificacion?',
            icon: "warning",
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                window.location = "ingreso.php?ID=" + encodeURI(id);
            }
        })
    }
</script>
