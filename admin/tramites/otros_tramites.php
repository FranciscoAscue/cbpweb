...
$sentencia = $conn_web->prepare("SELECT * FROM `TRAMITES_OTROS`;");
$sentencia->execute();
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `TRAMITES_OTROS` WHERE ID = :id;");
    ...
    <script>
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "otros_tramites.php";
            }
        })
    </script>
<?php } ?>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Tramites  &emsp;
            <a href="otros_tramites_agregar.php" class="btn btn-primary">+ Agregar Tramite</a>
            </h5>
                ...
                <tbody>
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <td scope="row">
                      <a name="" id="" class="btn btn-warning" href="otros_tramites_editar.php?ID=<?php echo $registro['ID']; ?>" 
...
<script>
    function borrar(id) {
        ...
        Swal.fire({
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                window.location = "otros_tramites.php?ID=" + encodeURI(id);
            }
        })
    }
</script>
