...
if(isset($_POST["seccion"])){
  ...
  $sentencia = $conn_web -> prepare("INSERT INTO `COLEGIATURA`(`ID`,`TAG`,`SECCION`,`CONTENIDO`,`PDF`) 
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Colegiatura</li>
          ...
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                ...
                <div class="col-sm-2">
                  <a name="" id="" class="btn btn-danger" href="/admin/tramites/colegiatura.php" role="button">Cancelar</a>
                </div>
              </div>
