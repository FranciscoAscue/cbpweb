...
if (isset($_GET['ID'])) {
  ...
  $NOSOTROS = $conn_web->prepare("SELECT * FROM `SEGUNDA_ESPECIALIDAD` WHERE `ID` = :id ;");
...
if(isset($_POST["seccion"])){
  ...
  $sentencia = $conn_web -> prepare("UPDATE `SEGUNDA_ESPECIALIDAD` SET `TAG` = :tag ,`SECCION` = :seccion, 
  ...
  if($tmp_pdf!=""){
    move_uploaded_file($tmp_pdf,"../../tramites/docs/".$nombre_archivo_pdf);
    ...
    $sentencia1 = $conn_web -> prepare("UPDATE `SEGUNDA_ESPECIALIDAD` SET `PDF` = :pdf WHERE ID = :id;");
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label for="cv" class="col-sm-3 col-form-label">
                  <a href="/tramites/docs/<?php echo $NOSOTROS_RES["PDF"]?>" >ACTUAL PDF</a>
                </label>
                <div class="col-sm-7">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                ...
                <div class="col-sm-2">
                  <a name="" id="" class="btn btn-danger" href="/admin/tramites/segunda_especialidad.php" role="button">Cancelar</a>
                </div>
              </div>
