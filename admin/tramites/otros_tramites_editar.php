...
if (isset($_GET['ID'])) {
  ...
  $NOSOTROS = $conn_web->prepare("SELECT * FROM `TRAMITES_OTROS` WHERE `ID` = :id ;");
...
if(isset($_POST["seccion"])){
  ...
  $sentencia = $conn_web -> prepare("UPDATE `TRAMITES_OTROS` SET `TAG` = :tag ,`SECCION` = :seccion, 
  ...
  if($tmp_pdf!=""){
    ...
    $sentencia = $conn_web->prepare("SELECT PDF FROM `TRAMITES_OTROS` WHERE ID=:id;");
    $sentencia->bindParam(":id", $ID);
    $sentencia->execute();
    ...
    $sentencia1 = $conn_web -> prepare("UPDATE `TRAMITES_OTROS` SET `PDF` = :pdf WHERE ID = :id;");
  ...
  header("Location:otros_tramites.php?mensaje=".$mensaje);
}
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="tramites" class="nav-content" data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="<?php echo $url_base; ?>tramites/otros_tramites.php" class="active">
...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Otros Tramites</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/admin/">Home</a></li>
        <li class="breadcrumb-item">Tramites</li>
        <li class="breadcrumb-item active">Otros tramites</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
          ...
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                ...
                <div class="col-sm-2">
                  <a name="" id="" class="btn btn-danger" href="/admin/tramites/otros_tramites.php" role="button">Cancelar</a>
                </div>
              </div>
