...
if (isset($_POST["seccion"])) {
  ...
  $sentencia = $conn_web->prepare("INSERT INTO `JNE_SECCION`(`ID`,`TAG`,`SECCION`) 
  ...
  header("Location:Jne_seccion.php?mensaje=" . $mensaje);
}
...
if (isset($_POST["ed_seccion"])) {
  ...
  $sentencia = $conn_web->prepare("UPDATE `JNE_SECCION` SET TAG = :tag, SECCION = :seccion WHERE ID=:id;");
...
if (isset($_GET['ID_E'])) {
  $ID_E = (isset($_GET['ID_E']) ? $_GET['ID_E'] : "");
  $editar = $conn_web->prepare("SELECT * FROM `JNE_SECCION` WHERE ID = :id;");
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `JNE_SECCION` WHERE ID = :id;");
  ...
  <script>
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "Jne_seccion.php";
      }
    })
  </script>
<?php } ?>
          ...
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                ...
                <div class="col-sm-2">
                  <?php if (isset($ID_E)) { ?>
                    <a name="" id="" class="btn btn-danger" href="/admin/elecciones/Jne_seccion.php" role="button">Cancelar</a>
                  <?php } else { ?>
                    <a name="" id="" class="btn btn-danger" href="/admin/elecciones/Jne.php" role="button">Regresar</a>
                  <?php } ?>
                  ...
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <td scope="row">
                        ...
                        <a name="" id="" class="btn btn-warning" href="Jne_seccion.php?ID_E=<?php echo $registro['ID']; ?>" role="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="bi bi-pencil me-1"></i></a>
...
<script>
  function borrar(id) {
    ...
    Swal.fire({
      ...
      /* Read more about isConfirmed, isDenied below */
      if (result.isConfirmed) {
        window.location = "Jne_seccion.php?ID=" + encodeURI(id);
      }
    })
  }
</script>
