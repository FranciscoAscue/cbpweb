...
$sentencia = $conn_web->prepare("SELECT *,(SELECT SECCION FROM `REGLAMENTO_FORMATOS_SECCION` 
WHERE `REGLAMENTO_FORMATOS_SECCION`.`ID` = `REGLAMENTO_FORMATOS`.`ID_SECCION` LIMIT 1) AS SECCION FROM `REGLAMENTO_FORMATOS`;");
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `REGLAMENTO_FORMATOS` WHERE ID = :id;");
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <a href="ReglamentoFormatos_agregar.php" class="btn btn-primary">+ Agregar Documento</a>
            <a href="ReglamentoFormatos_seccion.php" class="btn btn-warning">+ Crear/Editar Seccion</a>
            </h5>
                  ...
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <a name="" id="" class="btn btn-warning" 
                        href="ReglamentoFormatos_editar.php?ID=<?php echo $registro['ID']; ?>" 
...
<script>
    function borrar(id) {
        ...
        Swal.fire({
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                window.location = "ReglamentoFormatos.php?ID=" + encodeURI(id);
            }
        })
    }
</script>
