...
if(isset($_POST["seccion"])){
  ...
  $sentencia = $conn_web -> prepare("INSERT INTO `SICEBIOL`(`ID`,`TAG`,`SECCION`,`CONTENIDO`,`PDF`) 
  VALUES (null,:tag,:seccion,:contenido,:pdf );");
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label for="inputText" class="col-sm-3 col-form-label">TAG</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="tag" name="tag" required placeholder="Una sola palabra ...">
                </div>
              </div>
              <div class="row mb-3">
