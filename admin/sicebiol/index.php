<?php
include("../datbase.php");
$sentencia = $conn_web->prepare("SELECT * FROM `SICEBIOL`;");
$sentencia->execute();
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `SICEBIOL` WHERE ID = :id;");
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">SICEBIOL  &emsp;
            <a href="seccion_agregar.php" class="btn btn-primary">+ Agregar Seccion</a>
            </h5>
                  ...
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <a name="" id="" class="btn btn-warning" 
                        href="seccion_editar.php?ID=<?php echo $registro['ID']; ?>" 
...
<script>
    function borrar(id) {
        ...
        Swal.fire({
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                window.location = "index.php?ID=" + encodeURI(id);
            }
        })
    }
</script>
