<?php
include("../datbase.php");
$sentencia = $conn_web->prepare("SELECT * FROM `NOSOTROS`;");
$sentencia->execute();
...
if (isset($_GET['ID'])) {
  ...
  $sentencia1 = $conn_web->prepare("DELETE FROM `NOSOTROS` WHERE ID = :id;");
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Datos Institucionales  &emsp;
