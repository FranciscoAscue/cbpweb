...
if (isset($_GET['ID'])) {
  ...
  $CONSEJO_N = $conn_web->prepare("SELECT * FROM `CONSEJO_REGIONAL` WHERE `ID` = :id ;");
...
if(isset($_POST["id_consejo"])){
  ...
  $sentencia = $conn_web -> prepare("UPDATE `CONSEJO_REGIONAL` SET `NOMBRE` = :consejo_nombre ,`CARGO` = :consejo_cargo, 
  ...
  if($tmp_foto!=""){
    ...
    $sentencia = $conn_web->prepare("SELECT FOTO FROM `CONSEJO_REGIONAL` WHERE ID=:id;");
    $sentencia->bindParam(":id", $id_consejo);
    $sentencia->execute();
    ...
    $sentencia1 = $conn_web -> prepare("UPDATE `CONSEJO_REGIONAL` SET `FOTO` = :foto WHERE ID = :id;");
  ...
  header("Location:consejo_regional.php?mensaje=".$mensaje);
}
          ...
          <div class="card-body">
            ...
            <form action="" method="post" id="registro" enctype="multipart/form-data">
              ...
              <div class="row mb-3 d-flex justify-content-center">
                ...
                <div class="col-sm-2">
                  <a name="" id="" class="btn btn-danger" href="/admin/nosotros/consejo_regional.php" role="button">Cancelar</a>
                </div>
              </div>
