...
$sentencia = $conn_web->prepare("SELECT * FROM `CONSEJO_NACIONAL`;");
$sentencia->execute();
    ...
    <script>
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "consejo_nacional.php";
            }
        })
    </script>
<?php } ?>
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Consejo Directivo Nacional</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Gestión 2023 – 2025.  &emsp;
            </h5>
                  ...
                  <?php foreach ($busqueda as $registro) { ?>
                    <tr>
                      ...
                      <td scope="row">
                        ...
                        href="consejo_nacional_editar.php?ID=<?php echo $registro['ID']; ?>" 
